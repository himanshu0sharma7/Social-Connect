package com.example.twitter;//package com.example.pip
...
public class following_adapter extends RecyclerView.Adapter<following_adapter.ViewAdapter> {
    ...
    public following_adapter(Context context, List<String> pipDate) {
    ...
    public ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.scusername, parent, false);
